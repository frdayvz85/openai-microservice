...
def upload_music(url: str, folder: str):
    try:
        # Upload image to Cloudinary
        upload_result = cloudinary.uploader.upload_large(url, folder=folder, resource_type = "auto")
        # Return the URL of the uploaded music
        print("upload_result: ", upload_result)
        return upload_result['secure_url']
    except Exception as e:
        print("An error occurred:", e)
